...
function Projects() {
    return (
        <div className='mx-auto min-h-full w-full px-3 mt-14'>
            <h1 className='px-2 text-3xl text-primary dark:text-dark_primary resume_title'>Projects</h1>
                ...
                return (
                    <div className='project card md:card-side bg-foreground dark:bg-dark_foreground mt-10 md:drop-shadow-lg h-fit z-10'>
                        <figure className='self-center'>
                            <img className='md:max-h-80' src={e.img} alt={e.alt} />
                        </figure>
                        <div className='card-body'>
                            <h2 className='card-title text-primary dark:text-dark_primary project_title text-xl font-thin'>{e.name}</h2>
                            <p className='text-secondary dark:text-dark_secondary text-lg'>{e.description}</p>
